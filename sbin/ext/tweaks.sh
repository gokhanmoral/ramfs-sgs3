...
mount -o noatime,remount,rw,discard,barrier=0,commit=60,journal_async_commit,noauto_da_alloc,delalloc /cache /cache;
mount -o noatime,remount,rw,discard,barrier=0,commit=60,journal_async_commit,noauto_da_alloc,delalloc /data /data;
